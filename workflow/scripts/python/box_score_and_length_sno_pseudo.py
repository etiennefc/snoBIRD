...
# Select only pseudo snoRNA in the negatives
negatives_df = negatives_df[negatives_df['gene_biotype'] == 'snoRNA_pseudogene']
...
# Create columns for predicted start/end sites of snoRNA
# Add 5 nt around boxes because it's the median nb of
# flanking nt based on all expressed C/D snoRNAs
df['predicted_start'] = df.C_start - 5
df['predicted_end'] = df.D_end + 5

ddf['predicted_start'] = ddf.C_start - 5
ddf['predicted_end'] = ddf.D_end + 5
