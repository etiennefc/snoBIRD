...
model = BertForSequenceClassification2.from_pretrained(pretrained_model, num_labels=3, 
...
loss_fn = torch.nn.CrossEntropyLoss(weight=torch.tensor([1/20, 1, 1]).to(device))
